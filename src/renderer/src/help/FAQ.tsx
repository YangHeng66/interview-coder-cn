...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <span>
        ...
        <a
          href="https://github.com/YangHeng66/interview-coder-cn#关于隐身能力的说明"
          target="_blank"
          rel="noreferrer"
  ...
  },
  {
    ...
    answer: (
      <span>
        若希望无需手动发送，请在「设置 → 语音转录」打开「语音自动回答」。在文字对话模式下，检测到句末或短暂停顿后会自动提交；AI 正在回答时，新的完整语音会中止当前回答并按顺序继续处理。也可以继续按下
